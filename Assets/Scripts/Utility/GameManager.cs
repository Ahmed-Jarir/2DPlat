...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] private int gameManagerCoins = 0;
    ...
    public static int Coins
    {
        get
        {
            return instance.gameManagerCoins;
        }
        set
        {
            instance.gameManagerCoins = value;
        }
    }
    ...
    public static void AddCoin(int Coin)
    {
        ...
        Transform CoinDispPosition = GameObject.Find("CoinDisp").transform;
